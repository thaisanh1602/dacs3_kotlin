...
object GroqService {
    ...
    private val diseaseTranslations = mapOf(
        ...
        "leaf_blast"        to "Bệnh Đạo ôn lá",
        "neck_blast"        to "Bệnh Đạo ôn cổ bông",
        ...
        "sheath_rot"        to "Bệnh Thối bẹ lá",
        "false_smut"        to "Bệnh Ung thư lúa (False Smut)",
        "neck_rot"          to "Bệnh Thối cổ bông",
        "leaf_scald"        to "Bệnh Cháy lá",
    ...
    private fun translateToVietnamese(className: String): String {
        ...
        diseaseTranslations.entries
            .find { key.startsWith(it.key) || it.key.startsWith(key) }
            ?.let { return it.value }
        return className.replace("_", " ").replaceFirstChar { it.uppercase() }
    }
