...
object DataSeeder {
    ...
    fun seedData(uid: String? = null) {
        ...
        val fields = listOf(
            // Active Fields
            mapOf("id" to "1", "user_uid" to currentUid, "field_name" to "Ruộng Quế An 01", "area" to 5000.0, "location" to mapOf("latitude" to 15.629603, "longitude" to 108.215403), "current_rice_variant_id" to "1", "sowing_date" to dateFormat.parse("2026-05-01T07:00:00Z")?.let { Timestamp(it) }, "status" to "active"),
            mapOf("id" to "2", "user_uid" to currentUid, "field_name" to "Ruộng Ba Làng 02", "area" to 7500.0, "location" to mapOf("latitude" to 15.635000, "longitude" to 108.220000), "current_rice_variant_id" to "2", "sowing_date" to dateFormat.parse("2026-04-15T07:00:00Z")?.let { Timestamp(it) }, "status" to "active"),
            mapOf("id" to "3", "user_uid" to currentUid, "field_name" to "Ruộng Đồng Cát 03", "area" to 3000.0, "location" to mapOf("latitude" to 15.640000, "longitude" to 108.225000), "current_rice_variant_id" to "3", "sowing_date" to dateFormat.parse("2026-03-25T07:00:00Z")?.let { Timestamp(it) }, "status" to "active"),
            mapOf("id" to "4", "user_uid" to currentUid, "field_name" to "Ruộng Ven Sông 04", "area" to 10000.0, "location" to mapOf("latitude" to 15.645000, "longitude" to 108.230000), "current_rice_variant_id" to "4", "sowing_date" to dateFormat.parse("2026-03-05T07:00:00Z")?.let { Timestamp(it) }, "status" to "active"),
            // Harvested Fields (Sown in Jan/Feb)
            mapOf("id" to "5", "user_uid" to currentUid, "field_name" to "Ruộng Bàu Chát 05", "area" to 6000.0, "location" to mapOf("latitude" to 15.650000, "longitude" to 108.235000), "current_rice_variant_id" to "1", "sowing_date" to dateFormat.parse("2026-01-10T07:00:00Z")?.let { Timestamp(it) }, "status" to "harvested"),
            mapOf("id" to "6", "user_uid" to currentUid, "field_name" to "Ruộng Gò Nổi 06", "area" to 4500.0, "location" to mapOf("latitude" to 15.655000, "longitude" to 108.240000), "current_rice_variant_id" to "2", "sowing_date" to dateFormat.parse("2026-01-20T07:00:00Z")?.let { Timestamp(it) }, "status" to "harvested"),
            mapOf("id" to "7", "user_uid" to currentUid, "field_name" to "Ruộng Đồng Đế 07", "area" to 8000.0, "location" to mapOf("latitude" to 15.660000, "longitude" to 108.245000), "current_rice_variant_id" to "3", "sowing_date" to dateFormat.parse("2026-01-15T07:00:00Z")?.let { Timestamp(it) }, "status" to "harvested"),
            mapOf("id" to "8", "user_uid" to currentUid, "field_name" to "Ruộng Cửa Đại 08", "area" to 12000.0, "location" to mapOf("latitude" to 15.665000, "longitude" to 108.250000), "current_rice_variant_id" to "4", "sowing_date" to dateFormat.parse("2026-02-01T07:00:00Z")?.let { Timestamp(it) }, "status" to "harvested")
        )
